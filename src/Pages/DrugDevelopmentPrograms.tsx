...
const DrugDevelopmentPrograms = () => {
    ...
    const { "drugs-dev-program": drugDevPrograms }: { "drugs-dev-program": DrugDevProgram[] } = drugDevProgram;
        ...
        <>
            ...
            <Fragment>
                ...
                <Col xl={10} className="mx-auto my-10 d-none d-lg-block animate__animated animate__fadeInUp">
                    ...
                    <p>
                        Oocidia’s pipeline features seven first-in-class therapeutics targeting critical parasitic diseases in livestock and companion animals. Each program is tailored to address specific unmet needs in animal health while ensuring safety, efficacy, and practicality for farmers and veterinarians.
                    </p>
                    <DrugDevTable drugDevPrograms={drugDevPrograms} handleShowDetail={handleShowDetail} />
                </Col>
                ...
                <Col className="d-lg-none mt-5 mb-10">
                    ...
                    <DrugDevCarousel drugDevPrograms={drugDevPrograms} handleShowDetail={handleShowDetail} onCarouselControlClick={onCarouselControlClick} />
                </Col>

                {/* Why our Work matters */}
                <ImageSection title="Why our Work Matters ?" image={inpographic} imageAlt="inphographic parasitic diseases"
                ...
                <ComparisonTable comparisons={comparation.comparation} logoTab={logo_tab} />
