    ...
    return (
        <>
            ...
            <Fragment>
                <Row xs={1} lg={2} className="mt-4 g-3">
                    <Col lg={7}>
                        ...
                        <p className="animate__animated animate__fadeInLeft">
                            At Oocidia, innovation is at the core of our
                            mission. We focus on creating advanced solutions
                            that improve the health and well-being of animals.
                            Our team of experts constantly strives to push the
                            boundaries of veterinary medicine by integrating
                            cutting-edge technology, sustainable practices, and
                            rigorous research into every product we develop
                        </p>
                    </Col>
                ...
                <h2 className="text-blue-200 mb-4">
